...
@IBDesignable open class ASPVideoPlayer: UIView {
    ...
    open var videoPlayerView: ASPVideoPlayerView!
    ...
    open func unhideControls() {
        UIView.animate(withDuration: fadeDuration, animations: {
            self.videoPlayerControls.isHidden = false
            self.videoPlayerControls.alpha = 1.0
        })
    }
    
    @objc open func hideControlsTotally() {
        UIView.animate(withDuration: fadeDuration, animations: {
            self.videoPlayerControls.alpha = 0.0
            self.videoPlayerControls.isHidden = true
        })
    }
